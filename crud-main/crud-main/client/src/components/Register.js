...
const Register = () => {
    ...
    const addinpdata = async (e) => {
        ...
        const { name, email, classname, add, mobile, section, age } = inpval;
        ...
        const res = await fetch("https://crudappreactjs.herokuapp.com/register", {
            ...
            body: JSON.stringify({
                name, email, classname, add, mobile, section, age
            })
        });
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" value={inpval.classname} onChange={setdata} name="classname" class="form-control" id="exampleInputPassword1" />
                    </div>
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="mb-3 col-lg-12 col-md-12 col-12">
                        ...
                        <textarea name="section" value={inpval.section} onChange={setdata} className="form-control" id="" cols="30" rows="5"></textarea>
                    </div>
